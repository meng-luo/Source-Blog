...
const commentBarrageConfig = {
	...
	twikooUrl: "https://twikoo.dreamfall.cn/",
	//token获取见前文
	accessToken: "e2b622b0ce6de7e65a5f14041c3a6365",
...
function popCommentBarrage(data){
	...
	document.getElementById("barragesColor").innerHTML=`[data-theme='light'] .comment-barrage-item { background-color:rgba(255,255,255,.8);color:#000}[data-theme='dark'] .comment-barrage-item{ background-color:rgba(0,0,0,.6);color:#fff}`;
